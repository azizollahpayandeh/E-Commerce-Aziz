      ...
      <div className="mt-[100px] w-full h-auto  bg-[#000000] text-[#ffffff]">
        <div className="lg:pt-[80px] xl:pt-[100px] lg:pr-[80px] xl:pl-[100px] lg:pl-[80px] xl:pr-[100px] lg:pb-[50px] xl:pb-[70px]  flex flex-col justify-center items-center lg:items-start gap-10 lg:justify-between lg:flex-row">
          ...
          <div className="account  flex flex-col items-center lg:items-start gap-3">
            ...
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer ">My Account</p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">
              Login / Register
            </p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">Cart</p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">Wishlist</p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">Shop</p>
          </div>
          ...
          <div className="quickLink  flex flex-col items-center lg:items-start gap-3">
            ...
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">Terms Of Use</p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">FAQ</p>
            <p className="text-[16px] font-[400] text-gray-200 cursor-pointer">Contact</p>
          </div>
        ...
        <div className="flex justify-center items-center">
          <h1 className="text-[16px] font-[400] text-gray-400 pt-[10px] pb-[10px] ">created by <a href="Azizollah.ir">azizollah</a></h1>
        </div>
      </div>
    </>
  );
